 ...
 * 
 * This function randomly shuffles a vector of strings. 
 * 
 * @param first An iterator pointing to the first element in the vector
 * @param last An iterator pointing to the last element in the vector
 * @param g A Mersenne Twister 19937 generator object
 * 
 */
 ...
 * 
 * This constructor generates Middle-Earth using RNG and a seed. 
 * 
 * @param xsize The x size of the Middle-Earth being generated
 * @param ysize The y size of the Middle-Earth being generated
 * @param num_cities The number of cities being generated
 * @param seed The seed being used to randomly generate Middle-Earth
 * 
 */
 ...
 * 
 * This function prints out info on the created 'world'
 * 
 * 
 */
 ...
 * 
 * @param city1 The first city to measure distance between
 * @param city2 The second city of measure distance between
 * 
 * 
 ...
 * 
 * @param length The number of cities requested to visit
 * 
 * @return A vector with an itinerary of cities to go to
 * 
 */
